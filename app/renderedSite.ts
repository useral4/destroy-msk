...
<style id="destroy-static-compatibility">
  ...
  .elementor-2 .elementor-element.elementor-element-4ac6fe3.destroy-home-hero-pin-ready {
    position: relative !important;
    height: var(--destroy-home-hero-pin-height, 980px) !important;
    max-width: 100% !important;
    overflow: visible !important;
  }

  .elementor-2 .elementor-element.elementor-element-4ac6fe3.destroy-home-hero-pin-ready > .wrapper {
    position: relative !important;
    top: auto !important;
    z-index: 5 !important;
  }

  .elementor-2 .elementor-element.elementor-element-4ac6fe3.destroy-home-hero-pin-ready > .wrapper.destroy-home-hero-fixed {
    position: fixed !important;
    top: var(--destroy-home-hero-pin-top, 18px) !important;
    left: var(--destroy-home-hero-pin-left, 50px) !important;
    width: var(--destroy-home-hero-pin-width, 1160px) !important;
    z-index: 70 !important;
  }

  .elementor-2 .elementor-element.elementor-element-4ac6fe3.destroy-home-hero-pin-ready > .wrapper.destroy-home-hero-after {
  ...
  .elementor-2 .elementor-element.elementor-element-4ac6fe3 .wrapper {
    ...
    isolation: isolate;
    background-image: linear-gradient(90deg, rgba(0, 0, 0, 0.72), rgba(0, 0, 0, 0.34) 50%, rgba(0, 0, 0, 0.58)) !important;
  }

  .elementor-2 .elementor-element.elementor-element-4ac6fe3 .wrapper::before {
    z-index: 1 !important;
    background: linear-gradient(90deg, rgba(0, 0, 0, 0.62), rgba(0, 0, 0, 0.22) 52%, rgba(0, 0, 0, 0.5)) !important;
  ...
  .elementor-2 .elementor-element.elementor-element-4ac6fe3 .wrapper > .destroy-home-hero-inline-canvas {
    position: absolute;
    inset: 0;
    width: 100%;
    height: 100%;
    ...
    object-fit: cover;
    opacity: 1;
    transform: scale(var(--destroy-home-hero-scale, 1.035));
    transform-origin: center center;
    will-change: transform;
  }

  .elementor-2 .elementor-element.elementor-element-4ac6fe3 .wrapper > .destroy-home-hero-inline-glow {
    position: absolute;
    inset: auto -12% -24% -12%;
    height: 58%;
    z-index: 1;
    pointer-events: none;
    background: radial-gradient(ellipse at center, rgba(198, 13, 13, var(--destroy-home-hero-red, 0.24)), transparent 68%);
    filter: blur(20px);
    opacity: var(--destroy-home-hero-glow, 0.9);
    transform: scale(var(--destroy-home-hero-glow-scale, 1));
