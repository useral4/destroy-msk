...
.destroy-scroll-scene{position:relative;width:100vw;min-height:170vh;margin-left:calc(50% - 50vw);margin-right:calc(50% - 50vw);isolation:isolate}
...
@media (max-width:700px){.destroy-scroll-scene{min-height:155vh}.destroy-scroll-scene__sticky{top:0;min-height:100vh}.destroy-scroll-scene__overlay{width:min(100vw - 20px,100%);min-height:100vh}}
