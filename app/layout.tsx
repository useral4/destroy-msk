...
@media (max-width:700px){.destroy-scroll-scene{min-height:132vh}.destroy-scroll-scene__sticky{top:0;min-height:100vh}.destroy-scroll-scene__overlay{width:min(100vw - 20px,100%);min-height:100vh}}
