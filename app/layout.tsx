...
.destroy-scroll-scene{position:relative;width:var(--destroy-scene-vw,100vw);min-height:300vh;margin-left:calc(50% - var(--destroy-scene-half-vw,50vw));margin-right:calc(50% - var(--destroy-scene-half-vw,50vw));isolation:isolate}
...
@media (max-width:700px){.destroy-scroll-scene{min-height:280vh}.destroy-scroll-scene__sticky{top:0;min-height:100vh}.destroy-scroll-scene__overlay{width:min(calc(var(--destroy-scene-vw,100vw) - 20px),100%);min-height:100vh}}
